    ...
    if ret == RET_OK:
        ...
        for stock in HSI_list:
            ...
            if ret == RET_OK:
                ...
                if new_df['MA diff'][-1] > 0:
                    virtual_trade.Trade(price=price[-1],code=stock,trd_side=TrdSide.BUY)

                if new_df['MA diff'][-1] < 0:
                    virtual_trade.Trade(price=price[-1],code=stock,trd_side=TrdSide.SELL)
